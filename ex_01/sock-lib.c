...
int open_conection(struct sockaddr_in *my_addr, int port, int backlog, int debug)
{
	...
	if (debug)
		fprintf(stderr, "debug:: open_conection() socket()=%d\t..........OK\n", sockaux);
	...
	if (debug)
		fprintf(stderr, "debug:: open_conection() setsockopt()\t..........OK\n");
	...
	if (debug)
		fprintf(stderr, "debug:: open_conection() bind()\t\t..........OK\n");
	...
	if (debug)
		fprintf(stderr, "debug:: open_conection() listen()\t..........OK\n");
